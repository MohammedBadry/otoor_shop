@extends('layouts.otoraty.master', ['title' => $tester->name])
                    ...
                    <div class="product__carousel">
                        ...
                        <div class="swiper-container gallery-top">
                            <div class="swiper-wrapper">
                                @foreach($tester->getMedia() as $media)
                    ...
                    <div class="product-details--box pl-5">
                        <div class="product__details--top d-flex align-items-start mb-4">
                            <div class="product-details-right">
                                <p><span><i class="fas fa-arrow-left mt-2 mw-2"></i></span>{{ $tester->name }}</p>
                        ...
                        @if($tester->getDiscount() > 0)
                            <div class="text-left text-danger mb-4"><s>{{ price($tester->price) }}</s></div>
                        @endif
                        <div class="price text-left mb-4">{{ price($tester->getPrice()) }}</div>
                        ...
                        <div class="product__box--bottom d-flex justify-content-between align-items-center mb-4">
                            ...
                            {{ Form::hidden('item_id', $tester->id) }}
                            {{ Form::hidden('item_type', $tester->getMorphClass()) }}
                            <input type="hidden" name="product_id" value="{{ $tester->id }}"/>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="owl-product owl-carousel owl-theme">
                        @foreach($tester->products as $product)
